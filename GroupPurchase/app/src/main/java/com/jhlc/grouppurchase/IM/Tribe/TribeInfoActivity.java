...
//                startActivity(intent);
                Notification.showToastMsg(mContext,"修改群名称、群公告");
            }
        });
...
//                startActivityForResult(intent, EDIT_MY_TRIBE_NICK_REQUEST_CODE);
                Notification.showToastMsg(mContext," 修改我在本群的昵称");
            }
        });
...
//                startActivity(intent);
                Notification.showToastMsg(mContext,"TribePersonalSettingActivity");
            }
        });
...
//                startActivityForResult(intent, SET_MSG_REC_TYPE_REQUEST_CODE);
                Notification.showToastMsg(mContext,"设置群消息接收状态示例代码");
            }
        });
