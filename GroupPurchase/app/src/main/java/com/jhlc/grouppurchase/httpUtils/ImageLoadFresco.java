...
public class ImageLoadFresco {
    ...
    private ImageLoadFresco(LoadImageFrescoBuilder frescoBuilder) {
        ...
        if (frescoBuilder.mImageScaleType!=null){
            builderM.setActualImageScaleType(frescoBuilder.mImageScaleType);
        }
    ...
    public static class LoadImageFrescoBuilder {
        ...
        private ScalingUtils.ScaleType mImageScaleType;//图片的缩放
...
//            }
        ...
        public LoadImageFrescoBuilder setImageScaleType(ScalingUtils.ScaleType mImageScaleType){
