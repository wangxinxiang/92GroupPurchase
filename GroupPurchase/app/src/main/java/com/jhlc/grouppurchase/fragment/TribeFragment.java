...
import com.jhlc.grouppurchase.IM.Tribe.SearchTribeActivity;
import com.jhlc.grouppurchase.IM.Tribe.TribeAndRoomList;
import com.jhlc.grouppurchase.IM.Tribe.TribeConstants;
import com.jhlc.grouppurchase.IM.Tribe.TribeSampleHelper;
import com.jhlc.grouppurchase.R;
import com.jhlc.grouppurchase.IM.adapter.TribeAdapterSample;
import com.jhlc.grouppurchase.IM.Tribe.EditTribeInfoActivity;
...
//        mPullToRefreshListView.resetHeadLayout();
    ...
    private void showPopupMenu(View v) {
        final View bgView = View.inflate(QGApplication.getInstance(), R.layout.demo_popup_window_bg, null);
        ...
        View view = View.inflate(QGApplication.getInstance(), R.layout.demo_popup_menu, null);
