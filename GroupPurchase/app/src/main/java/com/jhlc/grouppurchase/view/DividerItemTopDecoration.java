 ...
 */
public class DividerItemTopDecoration extends RecyclerView.ItemDecoration
{
	...
	private boolean haveHead;       //是否有head
	...
	public DividerItemTopDecoration(Context context, int orientation)
	{
	...
	public void drawVertical(Canvas c, RecyclerView parent)
	{
		...
		for (int i = 0; i < childCount; i++)
		{
             ...
             * 判断是否是header，隐藏它
             */
            if (((RecyclerView.LayoutParams) child.getLayoutParams()).getViewLayoutPosition() == 0 && haveHead) {
                continue;
            }
